  ...
  return (
    ...
    >
      <div className="card-elegant relative mb-10 overflow-hidden p-8 text-center md:p-14">
        ...
        <div className="mb-8">
          <p className="mx-auto max-w-3xl text-2xl font-semibold leading-relaxed text-white">
      ...
      {showWechat && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 px-6 backdrop-blur-sm">
          <div className="relative w-full max-w-md rounded-3xl border border-white/10 bg-slate-950 p-8 text-center text-white shadow-2xl">
            <button
            ...
            <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-accent text-white">
